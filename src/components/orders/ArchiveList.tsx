    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_18px_30px_-26px_rgba(15,23,42,0.45)]">
      <div className="overflow-x-auto">
        <div className="min-w-[980px]">
          <div className="grid grid-cols-[1.05fr_1fr_0.95fr_0.9fr_0.8fr_1fr_0.8fr_1fr] gap-3 border-b border-slate-200 bg-slate-100 px-5 py-3 text-[11px] font-bold uppercase tracking-[0.14em] text-slate-600">
            <span>Job</span>
            <span>Client</span>
            <span>Job Type</span>
            <span>Stage</span>
          ...
          <div className="divide-y divide-slate-100">
            {orders.map((order) => (
              <article
                ...
                className="grid w-full grid-cols-[1.05fr_1fr_0.95fr_0.9fr_0.8fr_1fr_0.8fr_1fr] gap-3 px-5 py-4 text-left text-sm text-slate-800 transition hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-inset"
              >
                <span>
